...
void loop() { 
  ...
  if (irrecv.decode(&results)) {
    ...
    switch(results.value){
      case 16724175: if (RED > 245) {
                        RED == RED + 10; 
                        }
      break;
      
      case 16716015: if (RED < 6) {
                        RED == RED - 10;
                        }
      break;
      
      case 16718055: if (GREEN > 245) {
                        GREEN == GREEN - 10;
                        }
      break;
      
      case 16726215: if (GREEN < 6) {
                        GREEN == GREEN - 10;
                        }
      break;
      
      case 16743045: if (BLUE > 245) {
                        BLUE == BLUE - 10;
                        }
      break;
      
      case 16734885: if (BLUE < 6) {
                        BLUE == BLUE - 10;
                        }; 
      break;
      
      case 16730805: RED == 256, GREEN == 256, BLUE == 256; 
      break;
    }
    delay(50);
    irrecv.resume();
  ...
  switch(selectedEffect) {
    ...
    case 10 : {
                ...
                RunningLights(RED, GREEN, BLUE, 0);  // red
                break;
              }
    ...
    case 18 : {
                ...
                meteorRain(RED, GREEN, BLUE,10, 64, true, 10);
                break;
              }
  }
}
